...
public class ActivityController {
    ...
    public @ResponseBody Object queryActivityByConditionForPage(String name, String owner,String startDate,String endDate,
        ...
        //调用service层方法，查询数据
        List<Activity> activiyList = activityService.queryActivityByConditionForPage(map);
        int totalRows = activityService.queryCountOfActivityByCondition(map);
        //根据查询结果，生成响应信息
        Map<String,Object> retMap = new HashMap<>();
        retMap.put("activiyList",activiyList);
    ...
    public void fileDownload(HttpServletResponse response) throws IOException {
        ...
        //浏览器接收到响应信息之后，默认情况下，直接在显示窗口中打开响应信息，即使打不开，也会调用应用程序打开；只有实在打不开，才会激活文件
        //可以设置响应头信息，是浏览器接收到响应信息之后，直接激活文件下载窗口，即使能打开也不打开
        response.addHeader("Content-Disposition","attachment;filename=mystudentList.xls");

        //读取excel文件(InputStream),输出到浏览器（OutputStream）
        InputStream is = new FileInputStream("E:\\proj\\crm\\项目资料\\clientDir\\studentList.xls");
    ...
    public void exportAllActivitys(HttpServletResponse response) throws IOException {
        ...
        //创建exel文件，并且把activityList写入到文件中
        ...
        //wb对象生成excel文件
//        OutputStream os = new FileOutputStream("E:\\proj\\crm\\项目资料\\serverDir\\activitylist.xls");
//        wb.write(os);
//        //关闭资源
//        os.close();
//        wb.close();
        ...
        response.addHeader("Content-Disposition","attachment;filename=mystudentList.xls");
        OutputStream out = response.getOutputStream();
//        InputStream is = new FileInputStream("E:\\proj\\crm\\项目资料\\serverDir\\activitylist.xls");
//        byte[] buff = new byte[256];
//        int len = 0;
//        while((len = is.read(buff)) != -1){
//            out.write(buff,0,len);
